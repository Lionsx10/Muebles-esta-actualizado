    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">¿Por qué elegir Comercial HG?</h2>
...
onMounted(() => {
  ...
  // Probar conexión automáticamente al cargar (comentado temporalmente)
  // testXanoConnection()
})
</script>
    ...
    <section class="py-20 bg-blue-600 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <RouterLink
            to="/analisis-espacio"
            class="bg-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-purple-700 transition-colors"
          >
            Análisis de espacio con IA
          </RouterLink>
          <RouterLink
