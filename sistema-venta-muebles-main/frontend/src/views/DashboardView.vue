    ...
    <div class="mb-8">
      <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
        ...
        <p class="mt-2 text-blue-100">
          Estás en MueblesCorp, tu plataforma para encontrar los mejores muebles. Explora nuestro catálogo, obtén recomendaciones personalizadas y gestiona tus pedidos.
        </p>
