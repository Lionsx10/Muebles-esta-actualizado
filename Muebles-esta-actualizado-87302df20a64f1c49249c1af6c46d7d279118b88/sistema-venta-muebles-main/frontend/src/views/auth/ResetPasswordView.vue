<template>
  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form v-if="!passwordReset" class="mt-8 space-y-6" @submit.prevent="handleResetPassword">
        <div class="space-y-4">
...
const handleResetPassword = async () => {
  ...
  try {
    ...
    if (error.response?.status === 400) {
      errors.general = 'El enlace de restablecimiento es inválido o ha expirado.'
      ...
      errors.general = 'Error al restablecer la contraseña. Por favor, inténtalo de nuevo.'
    }
  } finally {
